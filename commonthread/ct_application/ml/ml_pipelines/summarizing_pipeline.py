...
class LocalSummarizingStrategy(SummarizingStrategy):
    ...
    def summarize_text(self, text: str) -> str:
        try:
            tokens = self.tokenizer.encode(text, truncation=True, max_length=1024, return_tensors="pt")
...
class CollectiveSummarizingStrategy(SummarizingStrategy):
    ...
    def summarize_text(self, text: str) -> str:
        ...
        raise NotImplementedError("CollectiveSummarizingStrategy is meant for summarizing multiple texts")
