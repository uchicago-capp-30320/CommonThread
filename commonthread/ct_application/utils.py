...
def find_user_by_email(email: str, user_model) -> Optional[object]:
    """
    Find a user by email in the given user model.

    Args:
        email (str): The email to search for.
        user_model: The user model to search in.
...
RESOURCE_ERRORS = {
    ...
    "BAD_FILTER": (
        400,
        "Specify exactly one of org_id, project_id, story_id, or user_id.",
    ),
}
